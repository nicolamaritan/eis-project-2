...
public class TestValues 
{
   ...
   /**
     ...
     * <p><b>Pre-Condition</b>: c contains {0="0":300="300"}, m and v are
     * empty.</p>
     * <p><b>Post-Condition</b>: c is unchanged, m contains
     * {300="300":400="400"}, while v contains {300:400}.</p>
     * <p><b>Expected Results</b>: Each removal is correctly propagated
     * from map to Values and from Values to map. In particular,
     * they still contains coherent informations.</p>
     */
     ...
     * <p><b>Test Description</b>: v.removeAll(c) is invoked when v is empty
     * and when v contains 10 elements. Tests propagation.</p>
     * <p><b>Pre-Condition</b>: c is empty, v is empty.</p>
     * <p><b>Post-Condition</b>: c is empty, v contains {"0":"10"}.</p>
    ...
    {
        assertFalse("Should be unchanged", v.removeAll(c));
        checkValues(m, v);
        checkIteration(v);
        initHMap(m, 0, 10);
        assertFalse("Should be unchanged", v.removeAll(c));
     ...
     * and the Values contains {"0":"i"}, for each i in (0,400)
     * (Note that empty map/Values limit case is being tested). Then
     ...
     * empty.</p>
     * <p><b>Post-Condition</b>: c is unchanged, m contains
     * {0="0":300="300"} and v contains {"0":"300"}.</p>
    ...
    public void RetainAll_Backing()
    {
        ...
        for (int i = 0; i < bound; i++)
        {
            ...
            if (i <= secondBound)
                ...
                assertTrue("Both should have size " + secondBound, m.size() == v.size() && m.size() == secondBound);
        }
    }
     ...
     * single Values.</p>
     * <p><b>Test Description</b>: esArr contains 50 the Values
